...
def load_and_preprocess(
    ...
    # ----------------------------------------------------------------------
    # FEATURE ENGINEERING ON N HOUSES (if present)
    # ----------------------------------------------------------------------
...
def load_data(partition_id: int, feature_splits: list[int], split="train"):
...
class ServerModel(nn.Module):
    def __init__(self, input_size: int, hidden_size: int = 96):
        ...
        self.bn = nn.BatchNorm1d(hidden_size)            # what does this add?
